...
public class MakeAllTablesDump {
	...
	public MakeAllTablesDump (final String strConfigFile) {
		...
		String                  strLog4jConfigFile                = null;
		...
		LOGGER = Logger.getLogger (MakeAllTablesDump.class);
		strLog4jConfigFile = "config" + File.separator + "log4j.xml";
		DOMConfigurator.configure(strLog4jConfigFile);
